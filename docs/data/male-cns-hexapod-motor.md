...
This assay resolves 24 exact antagonist motor populations, six exact proprioceptive banks, and
...
PYTHONPATH=src /Users/dulatnurlanuly/Downloads/flybrain/.venv/bin/flybrain \
  ...
  --steps 90 \
  --seed 7 \
  --output /Users/dulatnurlanuly/Downloads/flybrain/artifacts/hexapod-motor-malecns-seed7-mirrorfix.json
```
...
| Result SHA-256 | `ada6db8b97554168b05af5ee51730c1a572fda8ed0b9552c79315cfdc46c54a6` |
| Result size | 2,227,051 bytes |
| Graph | 166,606 neurons; 6,240,402 directed sparse edges |
| Protocol | 90 neural/body chunks; seed 7 |
...
| --- | --- | --- |
| Direct motor calibration | 24/24 `positive` | Every exact flexor/extensor population produced its declared antagonist joint effect; bounds, finite state, nonnegative energy, replay, and graph integrity passed. |
| Phase-gait calibration | `null` | The target-independent phase/body model failed stability, lateral-drift, fall, or alternating-support gating. This is not reported as walking. |
...
The closed-loop mirror condition explicitly swaps all six left/right sensory banks and all 24
